...
\data{Abril de 2017}
\instituicao{UNIVERSIDADE ESTADUAL DE MONTES CLAROS \par Centro de Ciências Exatas e Tecnológicas \par Programa de Pós-Graduação em Modelagem Computacional e Sistemas} 
...
\preambulo{Dissertação apresentada no Programa de Pós-Graduação em Modelagem Computacional e Sistemas, da Universidade Estadual de Montes Claros como exigência para obtenção do grau de Mestre em Modelagem Computacional e Sistemas.}
% ---
...
\begin{itemize}
	...
	\item Realizar comparações estatísticas entre o PSO proposto e outros métodos e técnicas clássicas encontradas na literatura.
\end{itemize}
